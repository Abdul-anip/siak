...
<div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 mb-8 text-white shadow-xl">
    <div class="flex items-center justify-between flex-wrap gap-4">
        <div>
            ...
            <p class="text-white/90">Kelola data Perkuliahan</p>
        </div>
        <div class="flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-xl">
            ...
            <div class="text-sm">
                ...
                <p class="opacity-90">Manajemen Perkuliahan</p>
            </div>
        </div>
    </div>
</div>
...
<div class="mb-8">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Menu Perkuliahan</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <a href="#" class="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-purple-300 transform hover:-translate-y-2">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-lg font-bold text-gray-800 mb-2">Jadwal Kuliah</h3>
                <p class="text-gray-600 text-sm mb-4">Lihat Jadwal Kuliah</p>
        ...
        <a href="#" class="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-300 transform hover:-translate-y-2">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-lg font-bold text-gray-800 mb-2">Modul Kuliah</h3>
                <p class="text-gray-600 text-sm mb-4">Lihat Modeul Kuliah</p>
                <div class="mt-auto pt-4 border-t border-gray-100 w-full">
        ...
        <a href="#" class="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-green-300 transform hover:-translate-y-2">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-lg font-bold text-gray-800 mb-2">Presensi Kuliah</h3>
                <p class="text-gray-600 text-sm mb-4">Lihat Presensi Kuliah</p>
                <div class="mt-auto pt-4 border-t border-gray-100 w-full">
        ...
        <a href="#" class="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-orange-300 transform hover:-translate-y-2">
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="text-lg font-bold text-gray-800 mb-2">Surat Peringatan</h3>
                <p class="text-gray-600 text-sm mb-4">Lihat Surat Peringatan</p>
                <div class="mt-auto pt-4 border-t border-gray-100 w-full">
